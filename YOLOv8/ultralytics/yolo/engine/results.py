...
class Results(SimpleClass):
    ...
    def plot(
        ...
        if pred_masks and show_masks:
            ...
            #annotator.masks(pred_masks.data, colors=[colors(1, True)], im_gpu=img_gpu) #标记框设置为红色，同时修改231
        ...
        if pred_boxes and show_boxes:
            for d in reversed(pred_boxes):
                ...
                annotator.box_label(d.xyxy.squeeze(), label, color=colors(0, True)) #根据223修改
